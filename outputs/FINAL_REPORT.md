...
**Đề 9 | Kaggle Water Potability (3,276 rows × 10 cols) | 2026-03-23**
...
- **k=3** (multi-metric voting)
- **Phương pháp**: Elbow + Silhouette Analysis + Multi-metric voting (k=2 đến k=8)
- **Metrics**: Silhouette=0.5360 | Davies-Bouldin=0.5627 | Calinski-Harabasz=7285.35

**Cluster Profiles:**
| Cluster | Size | Size % | Unsafe % | Risk Level |
| --- | --- | --- | --- | --- |
| 0 | 812 | 24.8% | 77.7% | 🔴 High Risk |
| 1 | 1501 | 45.8% | 60.0% | 🟡 Medium Risk |
| 2 | 963 | 29.4% | 48.3% | 🟡 Medium Risk |
...
1. [CRITICAL] Ensemble(XGB+ET+RF)+SMOTETomek: F1=0.9000, ROC-AUC=0.9548 — mô hình tốt nhất; triển khai kiểm tra chất lượng nước real-time
2. [CRITICAL] FP=38 mẫu bị báo SAI là nước sạch (nguy hiểm!) — khuyến nghị threshold=0.55 (F1 cao nhất) hoặc 0.40 (an toàn tối đa)
3. [HIGH] K-Means k=3: Silhouette=0.54, DBI=0.56 — phân 3 cụm rủi ro rõ ràng (An toàn/Hơi nguy hiểm/Nguy hiểm); multi-metric voting (2/3 metrics)
...
---
*Generated by run_pipeline.py v3 | 2026-03-23*
